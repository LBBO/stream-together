...
export const forwardEvent = (type: string, data: VideoEvent['data'], ws: ws | null, session: Session): void => {
...
export const broadcastEvent = (type: string, data: VideoEvent['data'], session: Session): void =>
